...
| `mods` / `mod_list` | — | #72 |
| `mod_item` | item id | #72 |
| `mod_reload` / `reload_mods` | — | #72 (same path as `POST /api/reload_defs`) |
| StreetNet `/<slash>` (chat) | mod-defined | #72 API 1.3 (`streetnet.json` commands) |
