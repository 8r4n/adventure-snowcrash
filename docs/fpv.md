...
Hiding GPS must not affect movement, combat, compass pills, flash toasts, or year-panel docks — only the minimap overlay is suppressed. Flash/journal toasts themselves coalesce identical lines within a short window (#124).
